    ...
    {{-- <div class="row"> --}}
            ...
            <div>
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="mb-0 mb-lg-0">
                        <h3 class="mb-0  text-white">Tambah Data Lahan Parkir</h3>
                    </div>
                    <div></div>
                </div>
            </div>
        ...
        <!-- card -->
            <div class="card ">
                <!-- card body -->
                <div class="card-body">
                    <form class="row g-3 needs-validation" novalidate action="/tambah-lahanParkir" method="POST">
                        @csrf
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" required placeholder="Masukkan Nama Lahan Parkir" name="namaLahanParkir">
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Harap Isi Bidang ini.</div>
                        </div>
                        <div class="col-md-4">
                            <label for="validationCustom02" class="form-label">Daya Tampung Lahan Parkir</label>
                            <input type="number" class="form-control" id="validationCustom02" required placeholder="Masukkan Total Daya Tampung" name="totalDayaTampung">
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Harap Isi Bidang ini.</div>
                        </div>
                        <div class="col-12">
