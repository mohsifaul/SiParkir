                ...
                <div class="card-body">
                    <form class="row g-3 needs-validation" novalidate action="/tambah" method="POST">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" required placeholder="Masukkan Nama Lahan Parkir">
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Harap Isi Bidang ini.</div>
                        </div>
                        <div class="col-md-4">
                            <label for="validationCustom02" class="form-label">Daya Tampung Lahan Parkir</label>
                            <input type="number" class="form-control" id="validationCustom02" required placeholder="Masukkan Total Daya Tampung">
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Harap Isi Bidang ini.</div>
                        </div>
                        <div class="col-12">
